...
class ProbabilityModelHandler:
    ...
    def __init__(self, thermo_measures_handler, time_operator):
    ...
    def update_probality_model(self):
        """
    ...
    def measured_probability(self, day, t):
        ...
        t_min = t
        t_max = t + 15*60 - 1
        list_of_presence_dico = self.thermo_measures_handler.get_presence_by_day_and_by_time_interval(day, t_min, t_max)
...
if __name__ == '__main__':
    ...
    TDB = d.ThermoDB('pres_data0.db', BASIC_DEVICE_TYPES)

    PMH = ProbabilityModelHandler(TDB.query_handler, u.TimeOperator(TDB.query_handler))
